...
git clone https://github.com/mumba4ever/device_motorola_mumba device/motorola/mumba
git clone https://github.com/mumba4ever/vendor_motorola_mumba vendor/motorola/mumba
